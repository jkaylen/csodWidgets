...
strUpcoming = ''; strRecent = ''; strUserNumber = '';strToken = '';strCultureName = '';strGetStarted = '';strCloud = '';strCorp = '';objFrequency = {};strConversationsJSURL = '';strPast='';strNoMeetings='';
var div = '';
...
function buildConversationsList(strRawData) {
   ...
   //elmParentDiv.innerHTML = '';
	 if(document.getElementById(div).previousElementSibling) {
...
function buildConvoRow(objConvo,bolUpcoming) {
	...
	var strDate = '';
	if((bolUpcoming) && ('nextMeetingDate' in objConvo.meetingsSummary)) {
